...
RUN wget https://huggingface.co/Kijai/WanVideo_comfy_GGUF/resolve/main/InfiniteTalk/Wan2_1-InfiniteTalk_Single_Q4_K_M.gguf -O /ComfyUI/models/diffusion_models/Wan2_1-InfiniteTalk_Single_Q4_K_M.gguf
...
RUN wget https://huggingface.co/city96/Wan2.1-I2V-14B-480P-gguf/resolve/main/wan2.1-i2v-14b-480p-Q5_0.gguf -O /ComfyUI/models/diffusion_models/wan2.1-i2v-14b-480p-Q5_0.gguf
